...
#define CYBLE_WIRELESS_RADAR_SENSOR_SERVICE_INDEX   (0x00u) /* Index of Wireless Radar Sensor service in the cyBle_customs array */
#define CYBLE_WIRELESS_RADAR_SENSOR_CUSTOM_CHARACTERISTIC_CHAR_INDEX   (0x00u) /* Index of Custom Characteristic characteristic */
#define CYBLE_WIRELESS_RADAR_SENSOR_CUSTOM_CHARACTERISTIC_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */


#define CYBLE_WIRELESS_RADAR_SENSOR_SERVICE_HANDLE   (0x0010u) /* Handle of Wireless Radar Sensor service */
#define CYBLE_WIRELESS_RADAR_SENSOR_CUSTOM_CHARACTERISTIC_DECL_HANDLE   (0x0011u) /* Handle of Custom Characteristic characteristic declaration */
#define CYBLE_WIRELESS_RADAR_SENSOR_CUSTOM_CHARACTERISTIC_CHAR_HANDLE   (0x0012u) /* Handle of Custom Characteristic characteristic */
#define CYBLE_WIRELESS_RADAR_SENSOR_CUSTOM_CHARACTERISTIC_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0013u) /* Handle of Client Characteristic Configuration descriptor */
