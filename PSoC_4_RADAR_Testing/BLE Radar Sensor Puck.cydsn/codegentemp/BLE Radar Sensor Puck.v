...
module BLE_v3_66_1 (
	...
	cy_clock_v1_0
		#(.id("e3caa534-5bd2-4313-8672-11d611ab6439/5ae6fa4d-f41a-4a35-8821-7ce70389cb0c"),
...
module top ;
	...
	cy_clock_v1_0
		#(.id("f06cde08-50cc-4ef9-94e7-55fbca4cc889"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__PHASE_DETECT_net;
	wire [0:0] tmpFB_0__PHASE_DETECT_net;
	wire [0:0] tmpIO_0__PHASE_DETECT_net;
	electrical [0:0] tmpSIOVREF__PHASE_DETECT_net;

	cy_psoc3_pins_v1_10
		#(.id("1a9ebccd-4557-40e5-a793-6015d09978fd"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PHASE_DETECT
		 (.oe(tmpOE__PHASE_DETECT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PHASE_DETECT_net[0:0]}),
		  .io({tmpIO_0__PHASE_DETECT_net[0:0]}),
		  .siovref(tmpSIOVREF__PHASE_DETECT_net),
		  .interrupt({Net_397}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__PHASE_DETECT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	assign tmpOE__TARGET_DETECT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__LED_DSLEEP_GREEN_net;
	wire [0:0] tmpFB_0__LED_DSLEEP_GREEN_net;
	wire [0:0] tmpIO_0__LED_DSLEEP_GREEN_net;
	wire [0:0] tmpINTERRUPT_0__LED_DSLEEP_GREEN_net;
	electrical [0:0] tmpSIOVREF__LED_DSLEEP_GREEN_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		LED_DSLEEP_GREEN
		 (.oe(tmpOE__LED_DSLEEP_GREEN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_DSLEEP_GREEN_net[0:0]}),
		  .io({tmpIO_0__LED_DSLEEP_GREEN_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_DSLEEP_GREEN_net),
		  .interrupt({tmpINTERRUPT_0__LED_DSLEEP_GREEN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_DSLEEP_GREEN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_SLEEP_BLUE_net;
	wire [0:0] tmpFB_0__LED_SLEEP_BLUE_net;
	wire [0:0] tmpIO_0__LED_SLEEP_BLUE_net;
	wire [0:0] tmpINTERRUPT_0__LED_SLEEP_BLUE_net;
	electrical [0:0] tmpSIOVREF__LED_SLEEP_BLUE_net;

	cy_psoc3_pins_v1_10
		#(.id("eb3f705d-ab72-4cf8-a928-ae284cb53cf4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_SLEEP_BLUE
		 (.oe(tmpOE__LED_SLEEP_BLUE_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_SLEEP_BLUE_net[0:0]}),
		  .io({tmpIO_0__LED_SLEEP_BLUE_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_SLEEP_BLUE_net),
		  .interrupt({tmpINTERRUPT_0__LED_SLEEP_BLUE_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
