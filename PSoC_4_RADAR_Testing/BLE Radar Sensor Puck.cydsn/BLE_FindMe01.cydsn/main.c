...
int main()
{
    ...
    for(;;)
    {
            ...
            blessState == CYBLE_BLESS_STATE_DEEPSLEEP)
        {
            ...
            UART_UartPutString("Going into Deep Sleep\r\n");
            CySysPmDeepSleep();
            UART_UartPutString("Exiting from Deep Sleep\r\n");
        }
        else if(blessState != CYBLE_BLESS_STATE_EVENT_CLOSE)
        {
            /* If BLESS is active, then configure PSoC 4 BLE system in 
             * Sleep mode (~1.6mA current consumption) */
            //UART_UartPutString("Going into Sleep\r\n");
            CySysPmSleep();
            //UART_UartPutString("Exiting From Sleep\r\n");
        }
        else
        {
