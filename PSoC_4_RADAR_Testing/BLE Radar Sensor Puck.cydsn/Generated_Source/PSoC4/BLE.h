...
#define CYBLE_GAP_ROLE_BROADCASTER                  (0u != (CYBLE_GAP_ROLE & CYBLE_GAP_BROADCASTER))
    ...
    #define CYBLE_FAST_ADV_INT_MIN                  (0x0030u)
    #define CYBLE_FAST_ADV_INT_MAX                  (0x0030u)
    #define CYBLE_FAST_ADV_TIMEOUT                  (0x003Cu)
    #define CYBLE_SLOW_ADV_ENABLED                  (0x01u)
    #define CYBLE_SLOW_ADV_INT_MIN                  (0x0960u)
    #define CYBLE_SLOW_ADV_INT_MAX                  (0x0960u)
    #define CYBLE_SLOW_ADV_TIMEOUT                  (0x0096u)
    #define CYBLE_GAPP_CONNECTION_INTERVAL_MIN      (0x0640u)
    #define CYBLE_GAPP_CONNECTION_INTERVAL_MAX      (0x0640u)
