...
{
    #ifdef timerInt_INTERRUPT_INTERRUPT_CALLBACK
        timerInt_Interrupt_InterruptCallback();
    #endif /* timerInt_INTERRUPT_INTERRUPT_CALLBACK */ 
...
{
    CyRamVectors[CYINT_IRQ_BASE + timerInt__INTC_NUMBER] = address;
}
...
{
    return CyRamVectors[CYINT_IRQ_BASE + timerInt__INTC_NUMBER];
}
...
*
*   Note calling timerInt_Start or timerInt_StartEx will 
*   override any effect this API would have had. This API should only be called
*   after timerInt_Start or timerInt_StartEx has been called. 
...
void timerInt_SetPriority(uint8 priority)
{
    ...
    uint32 priorityOffset = ((timerInt__INTC_NUMBER % 4u) * 8u) + 6u;
    
	interruptState = CyEnterCriticalSection();
    *timerInt_INTC_PRIOR = (*timerInt_INTC_PRIOR & (uint32)(~timerInt__INTC_PRIOR_MASK)) |
...
uint8 timerInt_GetPriority(void)
{
    ...
    priority = (*timerInt_INTC_PRIOR & timerInt__INTC_PRIOR_MASK) >> priorityOffset;
